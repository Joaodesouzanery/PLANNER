...
export interface CrmContact { id: string; name: string; customer_id?: string | null; pipeline_stage?: string | null; email?: string | null; phone?: string | null; company?: string | null; company_id?: string | null }
