...
import { ArrowUpRight, ArrowDownRight, CalendarClock, CalendarDays, CheckCircle2, DollarSign, RotateCcw, Wallet, RefreshCw } from "lucide-react";
...
const FinanceDashboard = () => {
  const { dashboardTransactions, capitalEvolution, currentMonthPlanSummary, upcomingPayables, reconcileTransactionMutation, allEvents, transactionsUpdatedAt } = useFinanceWorkspace();
