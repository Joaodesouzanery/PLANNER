...
// Fluxo canônico + helpers de data/realizado: extraídos p/ financePeriodSource.ts (puro/testável).
// Re-exportados aqui p/ compat — vários arquivos importam PeriodRow/effectiveDate/isRealized/buildPeriodSource daqui.
export { buildPeriodSource, effectiveDate, isRealized, isSyntheticId };
